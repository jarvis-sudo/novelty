    ...
    <section className='relative w-full h-screen overflow-hidden'>
        ...
        <div className='relative z-10 flex flex-col items-center justify-center h-full text-white/75 px-4 bg-black/50 '>
            ...
            <p className='text-base md:text-xl max-w-3xl text-center'>
                Novelty LifeSCiences, established in 2019 (Hyderabad, India), manufactures niche oral products (tablets, capsules, syrups) via integrated facilities in Hyderabad and Kala Amb, serving as a trusted partner for global pharma firms.
            </p>
        </div>
    </section>
  )
