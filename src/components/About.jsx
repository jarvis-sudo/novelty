...
const About = () => {
  return (
    <div className="lg:h-screen bg-[#e1eaed] flex flex-col lg:flex-row justify-center gap-6 items-center lg:gap-16 px-4 sm:px-8 lg:px-12 xl:px-20 py-6 lg:py-12 overflow-hidden">
      <div className="flex flex-col items-start gap-4 lg:gap-5">
        ...
        <button className="bg-[#ef6c00] text-white px-6 py-3 rounded-md shadow hover:bg-orange-700 transition duration-300 text-sm sm:text-base fofnt-medium mt-2">
          Read More !
        </button>
      </div>
      <div className="w-full max-w-lg lg:max-w-xl flex justify-center">
        <img src="/d5.png" alt="doctor"
