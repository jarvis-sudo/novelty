...
const About = () => {
  return (
    <div className="lg:h-screen flex flex-col lg:flex-row justify-center gap-6 items-center lg:gap-16 px-4 sm:px-8 lg:px-12 xl:px-20 py-6 lg:py-12 overflow-hidden">
